...
<div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
        <a href="${pageContext.request.contextPath}/aaoemployee/main"><img src="${pageContext.request.contextPath}/img/logobk.png" alt=""></a>
    </div>
    ...
    <nav class="humberger__menu__nav mobile-menu">
        <ul>
            <li class="${opt_active_0}"><a href="${pageContext.request.contextPath}/aaoemployee/main">Trang chủ</a></li>
        ...
        <div class="row">
            <div class="col-lg-1 border-top ">
                <div class="header__logo">
                    <a href="${pageContext.request.contextPath}/aaoemployee/main"><img src="${pageContext.request.contextPath}/img/logobk.png" alt="" style="width:50px;height:50px;"></a>
                </div>
            </div>
            <div class="col-lg-10">
