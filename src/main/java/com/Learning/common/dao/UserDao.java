...
//		}
//	}
	public static void editUser(String  userID, User newUser, boolean editType) {
		...
		if (newUser.getUsername().length()>0) {
			...
			updateUserName(newUser.getUsername(), userID);
		}
		if (newUser.getUsername().length() > 0) {
...
//	}
	...
	//Update user name
	public static boolean updateUserName(String name, String  userID) {
		boolean isUpdated = false;
		//Simple handle exception
		Connection conn=getConnection();
		try {
	...
	//Update user name
	public static boolean updateUserEmail(String name, String  userID) {
		boolean isUpdated = false;
		//Simple handle exception
		Connection conn=getConnection();
		try {
	...
	//Update user phone
	public static boolean updateUserPhone(String phoneNumber,String  userID) {
		boolean isUpdated = false;
		//Simple handle exception
		Connection conn=getConnection();
		try {
	...
	public static boolean updateUserType(String type, String  userID) {
		boolean isUpdated = false;
		//Simple handle exception
		Connection conn=getConnection();
		try {
	...
	public static boolean updateUserUserName(String userName, String userID) {
		boolean isUpdated = false;
		//Simple handle exception
		Connection conn=getConnection();
		try {
